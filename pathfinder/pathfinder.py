...
ORIGINAL_DATA_DIR_32 = "/media/sieva/Tera10/datasets/pathfinder32"


class Pathfinder32(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for Pathfinder32 dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(Pathfinder32): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(Pathfinder32): Downloads the data and defines the splits
    # path = dl_manager.download_and_extract('https://todo-data-url')

    path = ORIGINAL_DATA_DIR_32
    # TODO(Pathfinder32): Returns the Dict[split names, Iterator[Key, Example]]
    return {
        'easy': self._generate_examples(path +"/curv_baseline"),
        'intermediate': self._generate_examples(path +"/curv_contour_length_9"),
        'hard': self._generate_examples(path +"/curv_contour_length_14"),
    }

  def _generate_examples(self, path):
    """Yields examples."""
    # TODO(Pathfinder32): Yields (key, example) tuples from the dataset
...
class Pathfinder32_org(tfds.core.BeamBasedBuilder):
...
class Pathfinder128_org(tfds.core.BeamBasedBuilder):
...
class Pathfinder128(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for Pathfinder128 dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    """Returns the dataset metadata."""
    # TODO(Pathfinder128): Specifies the tfds.core.DatasetInfo object
    return tfds.core.DatasetInfo(
        builder=self,
        description=('This is a builder for pathfinder challenge dataset'),
        features=tfds.features.FeaturesDict({
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    """Returns SplitGenerators."""
    # TODO(Pathfinder128): Downloads the data and defines the splits
    # path = dl_manager.download_and_extract('https://todo-data-url')

    path = ORIGINAL_DATA_DIR_128
    # TODO(Pathfinder128): Returns the Dict[split names, Iterator[Key, Example]]
    return {
        'easy': self._generate_examples(path +"/curv_baseline"),
        'intermediate': self._generate_examples(path +"/curv_contour_length_9"),
        'hard': self._generate_examples(path +"/curv_contour_length_14"),
  ...
  def _generate_examples(self, path):
    """Yields examples."""
    # TODO(Pathfinder128): Yields (key, example) tuples from the dataset
    # for f in path.glob('*.png'):
    #   yield 'key', {
    #       'image': f,
    #       'label': 'yes',
